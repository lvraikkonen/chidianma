...
export const GROUP_ROUTES = {
  ...
  poiGeocode: (groupId: string) => `/api/groups/${groupId}/poi/geocode`,
  poiSearch: (groupId: string) => `/api/groups/${groupId}/poi/search`,
  restaurantImport: (groupId: string) => `/api/groups/${groupId}/restaurants/import`,
